...
# File Splitting Settings - SMART LOGIC
TELEGRAM_FILE_LIMIT = 2000  # 2GB limit in MB
SAFE_SPLIT_SIZE = 1950  # MB per part (buffer for safety)
MIN_PART_SIZE = 50  # MB minimum per part
